...
import io.github.vennarshulytz.validation.annotation.constraints.NegativeOrZeroCheck;
...
public class NegativeOrZeroValidator extends AbstractSignValidator implements FieldValidator {
    ...
    public String validate(String fieldName, Object value, Map<String, Object> params, boolean enableI18n) {
        ...
        if (signum > 0) {
            return getErrorMessage(MessageConstants.NegativeOrZero, params, enableI18n);
